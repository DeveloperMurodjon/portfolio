...
export default function About() {
	return (
		<div className='container mt-[100px] flex flex-col items-center '>
			{/* Title */}
			<h3 className='font-bold text-[48px] font-sora pb-16'>Men haqimda</h3>
			...
			<div className='w-full  flex flex-col items-center gap-8 my-[170px]'>
				...
				<p className='text-lg leading-8 font-inter text-center text-neutral-700'>
				...
				<ul className='flex gap-12  text-lg justify-between'>
					<li className=' text-lg leading-8 text-neutral-700	 flex flex-col items-center'>
			...
			<div className='w-full  mb-10 flex flex-col items-center'>
				...
				<ul className='list-disc list-inside text-lg  space-y-2'>
					<li className=' text-lg leading-8 text-neutral-700'>
						Yangi narsalarni o‘rganish
					</li>
					<li className=' text-lg leading-8 text-neutral-700'>
						Kitob o‘qish va bu orqali dunyoqarashni kengaytirish
					</li>
					<li className=' text-lg leading-8 text-neutral-700'>Aql sporti</li>
					<li className=' text-lg leading-8 text-neutral-700'>
