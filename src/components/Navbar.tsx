...
export default function Navbar() {
  ...
  return (
    <div className="sticky top-16 md:top-4 bg-white z-50 shadow-sm rounded-3xl container flex justify-between items-center mt-[16px] pt-1  pb-[10px]">
      <Link href={"/"}>
      ...
      <div className="md:hidden">
        <button onClick={() => setOpen(!open)} className="flex flex-col gap-1">
          {open ? (
            <span className="text-3xl">×</span> // bu x belgisini ko‘rsatadi
          ) : (
            <>
